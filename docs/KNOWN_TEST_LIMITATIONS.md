...
All collaboration tests are gated behind the `collaboration` build tag as the feature is disabled for single-user mode. See [docs/COLLABORATION_FUTURE.md](COLLABORATION_FUTURE.md) for details.
