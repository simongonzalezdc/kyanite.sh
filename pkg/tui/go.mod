module github.com/kyanite/tui

go 1.26.0

toolchain go1.26.5

replace github.com/kyanite/design => ../design

replace github.com/kyanite/ai => ../ai

replace github.com/kyanite/config => ../config

replace github.com/kyanite/session => ../session
...
require (
	...
	github.com/kyanite/session v0.0.0-00010101000000-000000000000
)
